...
# these are also available in the supplementary material (Tables S4 - S7)
...
fig2 <- ggplot(gamviz, aes(x, predicted, ymin = conf.low, ymax = conf.high)) +
...
#ggsave(plot = fig2, filename="Fig2.png",dpi=600,width=94,height=60,units="mm")
